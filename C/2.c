...
heading_font = pygame.font.SysFont("Arial", 40)
...
def start_game():
    statements = [
        ...
        "Raju Baju, a renowned scientist, created plans for an invisibility machine.",
        ...
        "Our two cats, just love to play with their pink ball of yarn.",
        "We climbed to the top of the mountain in just under two hours; isn’t that great?",
        "Raju and Pinky are two big mad people.",
    ]
    ...
    print("the sum is a+b, a*b, a/b, a**b, a//amg")
